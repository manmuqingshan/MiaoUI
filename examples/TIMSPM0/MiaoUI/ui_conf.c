...
ui_item_t Contrast_Item, Power_Item, MenuColor_Item, CursorAni_Item, Test_Item,Contras_Item;
...
void Create_Parameter(ui_t *ui)
{
    ...
    static int Contras = 255;
    static ui_data_t Contras_data;
    Contras_data.name = "Contras";
    Contras_data.ptr = &Contras;
//    Contras_data.function = Disp_SetContrast;
    Contras_data.functionType = UI_DATA_FUNCTION_STEP_EXECUTE;
    Contras_data.dataType = UI_DATA_INT;
    Contras_data.actionType = UI_DATA_ACTION_RW;
    Contras_data.max = 255;
    Contras_data.min = 0;
    Contras_data.step = 5;
    static ui_element_t Contras_element;
    Contras_element.data = &Contras_data;
    Create_element(&Contras_Item, &Contras_element);
    ...
    AddPage("[HomePage]", &Home_Page, UI_PAGE_ICON);
        ...
        AddItem("-System", UI_ITEM_PARENTS, logo_allArray[1], &System_Item, &Home_Page, &System_Page, NULL);
            AddPage("[System]", &System_Page, UI_PAGE_TEXT);
                ...
                AddItem(" -Contras", UI_ITEM_DATA, NULL, &Contras_Item, &System_Page, NULL, NULL);
